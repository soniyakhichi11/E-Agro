...
router.post("/addtractors",authMiddleware,upload.single("image"), tractorController.addTractorForRent); // Add a tractor
router.get("/gettractors", tractorController.getAllTractors); // Get all tractors
router.post("/booktractors/book/:id",authMiddleware, tractorController.bookTractor); // Book a tractor
