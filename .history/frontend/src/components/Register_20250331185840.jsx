...
export const Register = () => {
  ...
  return (
    ...
    <div className="container">
      ...
      <div className="left-section">
         {/* <div><h1 className="e-agro-title">E-Agro</h1></div> 
         <br></br>
         <div>
          <p className="register-text">Register yourself for a better experience</p>
          </div> */}

         <div className="left-section">
          <h1 className="e-agro-title">E-Agro</h1>
          <h4 className="register-text">Register yourself for a better experience</h4>
        </div>
        </div>
