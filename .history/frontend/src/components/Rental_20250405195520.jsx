...
import { faRupeeSign, faMapMarkerAlt, faUser, faCheckCircle, faCalendarAlt, faPlus,faCalendar, faTractor, faPlusCircle, faInfoCircle } from "@fortawesome/free-solid-svg-icons";
...
<main className="container-rental">
    ...
    <aside className="sidebar">
        ...
        <hr></hr>
        <ul>
        <li><FontAwesomeIcon icon={faTractor} /> Rent Agricultural Tools</li>
