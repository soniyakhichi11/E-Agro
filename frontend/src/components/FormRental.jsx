...
export const FormRental = () => {
    ...
    const handleFileChange = (e) => {
        setFormData((prevData) => ({
          ...prevData,
          image: e.target.files[0], // Make sure it's the file object
        }));
      };
    ...
    const handleSubmit = async (e) => {
        ...
        console.log("🖼️ formData.image (File object):", formData.image);
        ...
        try {
            ...
            console.log("🚀 Debug: API Response:", response); //added2  .data htaya res k bd
